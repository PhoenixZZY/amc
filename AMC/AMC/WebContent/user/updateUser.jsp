...
<body>
	<s:form method="post" class="definewidth m20" action="updateUser">
		<table class="table table-bordered table-hover m10">
			...
			<tr>
				...
				<td><input type="text" name="user.department"
					value="${user.department}" /></td>
			</tr>
			<tr>
				<td width="10%" class="tableleft">角色名</td>
				<td><select class="selector" name="user.roleId">
